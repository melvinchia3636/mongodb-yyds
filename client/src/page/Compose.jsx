    ...
    <div className="w-full flex-1">
      <div className="flex items-center justify-between w-full h-min">
        ...
        <div className="flex items-center gap-2">
          <Link to="/" className="font-medium flex items-center justify-center w-32 hover:bg-slate-300 hover:bg-opacity-80 hover:shadow-md py-4 rounded-md transition-all">Cancel</Link>
          <button type="button" onClick={publish} className="bg-slate-800 text-slate-200 tracking-wider rounded-md font-medium py-4 shadow-md flex items-center justify-center gap-2 w-40">
            Publish
      ...
      />
      <label className="mt-6 mb-2 block ml-1 font-medium">Article Content</label>
